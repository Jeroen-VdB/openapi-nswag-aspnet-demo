...
namespace ClientSideApplication.V1
{
    ...
    {
        private string _baseUrl = "https://localhost:7027/api/v1";
        ...
        public virtual async System.Threading.Tasks.Task<ApiResponse> UploadFileAsync(long petId, string additionalMetadata, System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
            ...
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("additionalMetadata") + "=").Append(System.Uri.EscapeDataString(ConvertToString(additionalMetadata, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
            urlBuilder_.Length--;
